...
@section('title', __('pages.title').__(' | Edit Anggota'))
@section('titleContent', __('Edit Anggota'))
@section('breadcrumb', __('Data'))
@section('morebreadcrumb')
<div class="breadcrumb-item active">{{ __('Anggota') }}</div>
<div class="breadcrumb-item active">{{ __('Edit Anggota') }}</div>
@endsection
        ...
        <div class="card-body">
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control datepicker @error('tgllahir') is-invalid @enderror"
                            name="tgllahir" value="{{ $member->tgllahir }}" required>
                        @error('tgllahir')
                        <span class="text-danger" role="alert">
                            {{ $message }}
                        </span>
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('ibukandung') is-invalid @enderror"
                            name="ibukandung" value="{{ $member->ibukandung }}" required>
                        @error('ibukandung')
                        <span class="text-danger" role="alert">
                            {{ $message }}
                        </span>
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('thnstatuskawin') is-invalid @enderror"
                            name="thnstatuskawin" value="{{ $member->thnstatuskawin }}" required>
            ...
            <div class="row">
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('kel') is-invalid @enderror" name="kel" value="{{ $member->kel }}" required>
                        @error('kel')
                        <span class="text-danger" role="alert">
                            {{ $message }}
                        </span>
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('kec') is-invalid @enderror" name="kec" value="{{ $member->kec }}" required>
                        @error('kec')
                        <span class="text-danger" role="alert">
                            {{ $message }}
                        </span>
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('kab') is-invalid @enderror" name="kab" value="{{ $member->kab }}" required>
                        @error('kab')
                        <span class="text-danger" role="alert">
                            {{ $message }}
                        </span>
            ...
            <div class="row">
                <div class="col-xs-12 col-md-8">
                    <div class="form-group">
                        ...
                        value="{{ $member->domisili }}" required>
                        @error('domisili')
                        <span class="text-danger" role="alert">
                            {{ $message }}
                        </span>
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        value="{{ $member->dom_rtrw }}" required>
                        @error('dom_rtrw')
                        <span class="text-danger" role="alert">
                            {{ $message }}
                        </span>
            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        value="{{ $member->dom_prov }}" required>
                        @error('dom_prov')
                        <span class="text-danger" role="alert">
                            {{ $message }}
                        </span>
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('stts_tmpttgl_lain') is-invalid @enderror"
                            name="stts_tmpttgl_lain" value="{{ $member->stts_tmpttgl_lain }}">
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('pend_terakhir_thn') is-invalid @enderror"
                            name="pend_terakhir_thn" value="{{ $member->pend_terakhir_thn }}" required>
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('gaji_perbulan') is-invalid @enderror"
                            name="gaji_perbulan" value="{{ $member->gaji_perbulan }}" required>
                        @error('gaji_perbulan')
                        <span class="text-danger" role="alert">
                            {{ $message }}
                        </span>
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('nom_tab_terbilang') is-invalid @enderror"
                            name="nom_tab_terbilang" value="{{ $member->nom_tab_terbilang }}" required>
            ...
            <div class="form-group">
                ...
                <textarea type="text" class="form-control @error('info') is-invalid @enderror" name="info" cols="150"
                    rows="10" style="height: 77px;">{{ $member->info }}</textarea>
                @error('info')
                <span class="text-danger" role="alert">
                    {{ $message }}
                </span>
