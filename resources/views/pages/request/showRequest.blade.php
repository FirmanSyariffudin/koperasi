        ...
        <div class="card-body">
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('tmpt_lahir') is-invalid @enderror"
                            name="tmpt_lahir" value="{{ $request->tmpt_lahir }}" readonly>
                        @error('tmpt_lahir')
                        <span class="text-danger" role="alert">
                            {{ $message }}
                        </span>
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('no_orgdkt') is-invalid @enderror"
                            name="no_orgdkt" value="{{ $request->no_orgdkt }}" readonly>
                        @error('no_orgdkt')
                        <span class="text-danger" role="alert">
                            {{ $message }}
                        </span>
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('thn_kawin') is-invalid @enderror"
                            name="thn_kawin" value="{{ $request->thn_kawin }}" readonly>
                        @error('thn_kawin')
                        <span class="text-danger" role="alert">
                            {{ $message }}
                        </span>
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('rmhtgl_lain') is-invalid @enderror"
                            name="rmhtgl_lain" value="{{ $request->rmhtgl_lain }}" readonly>
                        @error('rmhtgl_lain')
                        <span class="text-danger" role="alert">
                            {{ $message }}
                        </span>
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('pend_lain') is-invalid @enderror"
                            name="pend_lain" value="{{ $request->pend_lain }}" readonly>
                        @error('pend_lain')
                        <span class="text-danger" role="alert">
                            {{ $message }}
                        </span>
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('pkerjaan') is-invalid @enderror" name="pkerjaan"
                            value="{{ $request->pkerjaan }}" readonly>
                        @error('pkerjaan')
                        <span class="text-danger" role="alert">
                            {{ $message }}
                        </span>
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('prusahaan') is-invalid @enderror"
                            name="prusahaan" value="{{ $request->prusahaan }}" readonly>
                        @error('prusahaan')
                        <span class="text-danger" role="alert">
                            {{ $message }}
                        </span>
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('almt_prshaan') is-invalid @enderror"
                            name="almt_prshaan" value="{{ $request->almt_prshaan }}" readonly>
                        @error('almt_prshaan')
                        <span class="text-danger" role="alert">
                            {{ $message }}
                        </span>
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('ikut_tgjwb') is-invalid @enderror"
                            name="ikut_tgjwb" value="{{ $request->ikut_tgjwb }}" readonly>
                        @error('ikut_tgjwb')
                        <span class="text-danger" role="alert">
                            {{ $message }}
                        </span>
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('no_prusahaan') is-invalid @enderror"
                            name="no_prusahaan" value="{{ $request->no_prusahaan }}" readonly>
                        @error('no_prusahaan')
                        <span class="text-danger" role="alert">
                            {{ $message }}
                        </span>
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('tg_kluarga') is-invalid @enderror"
                            name="tg_kluarga" value="{{ $request->tg_kluarga }}" readonly>
                        @error('tg_kluarga')
                        <span class="text-danger" role="alert">
                            {{ $message }}
                        </span>
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('pendapatan') is-invalid @enderror"
                            name="pendapatan" value="{{ $request->pendapatan }}" readonly>
                        @error('pendapatan')
                        <span class="text-danger" role="alert">
                            {{ $message }}
                        </span>
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('ket_pendapatan') is-invalid @enderror"
                            name="ket_pendapatan" value="{{ $request->ket_pendapatan }}" readonly>
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('jml_pngajuan') is-invalid @enderror"
                            name="jml_pngajuan" value="{{ $request->jml_pngajuan }}" readonly>
                        @error('jml_pngajuan')
                        <span class="text-danger" role="alert">
                            {{ $message }}
                        </span>
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('terbilang') is-invalid @enderror"
                            name="terbilang" value="{{ $request->terbilang }}" readonly>
                        @error('terbilang')
                        <span class="text-danger" role="alert">
                            {{ $message }}
                        </span>
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('jml_disetujui') is-invalid @enderror"
                            name="jml_disetujui" value="{{ $request->jml_disetujui }}" readonly>
                        @error('jml_disetujui')
                        <span class="text-danger" role="alert">
                            {{ $message }}
                        </span>
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('jml_disetujui2') is-invalid @enderror"
                            name="jml_disetujui2" value="{{ $request->jml_disetujui2 }}" readonly>
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('jml_disetujui3') is-invalid @enderror"
                            name="jml_disetujui3" value="{{ $request->jml_disetujui3 }}" readonly>
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('jml_disetujui4') is-invalid @enderror"
                            name="jml_disetujui4" value="{{ $request->jml_disetujui4 }}" readonly>
            ...
            <div class="form-group">
                ...
                <textarea type="text" class="form-control @error('keperluan') is-invalid @enderror" name="keperluan"
                    cols="150" rows="10" style="height: 77px;" readonly>{{ $request->keperluan }}</textarea>
                @error('keperluan')
                <span class="text-danger" role="alert">
                    {{ $message }}
                </span>
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('jngka_wkt') is-invalid @enderror"
                            name="jngka_wkt" value="{{ $request->jngka_wkt }}" readonly>
                        @error('jngka_wkt')
                        <span class="text-danger" role="alert">
                            {{ $message }}
                        </span>
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('akad_pemb') is-invalid @enderror"
                            name="akad_pemb" value="{{ $request->akad_pemb }}" readonly>
                        @error('akad_pemb')
                        <span class="text-danger" role="alert">
                            {{ $message }}
                        </span>
